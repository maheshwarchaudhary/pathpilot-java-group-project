...
<%
    ...
    String phaseIdParam = request.getParameter("phase");
    ...
    String leftBtnUrl = request.getContextPath() + "/student/progress";
%>
...
<div class="max-w-5xl mx-auto py-12 px-6">
    ...
    <div class="mb-8">
        <nav class="flex text-sm text-gray-500 mb-2 gap-2">
            <a href="<%=request.getContextPath()%>/student/progress?title=<%=title%>" class="hover:text-indigo-600 font-medium">Roadmap</a>
            <span>/</span>
    ...
    <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden mb-8">
        ...
        <div id="quizUnlockSection" class="hidden p-10 border-t border-gray-100 bg-indigo-50/20 text-center">
            <div class="max-w-md mx-auto">
                ...
                <a href="<%=request.getContextPath()%>/student/quiz/<%=phaseIdParam%>" 
        ...
        if(pdfOpened && videoInteracted) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<%=request.getContextPath()%>/student/quiz/<%=phaseIdParam%>";
                }
            });
        }
