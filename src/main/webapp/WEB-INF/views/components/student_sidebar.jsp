...
<%-- Logic: Minimalist Student Sidebar with dedicated Quotes Page link --%>
...
<aside class="flex flex-col justify-between h-screen sticky top-0 bg-white border-r border-gray-100 p-4 transition-all duration-300 font-['Plus_Jakarta_Sans']
    ...
    <div>
        ...
        <nav class="space-y-2">
            ...
            <a href="<%=request.getContextPath()%>/student/certificates" title="My Certificates"
               class="flex items-center gap-4 px-3 py-3 transition rounded-2xl font-semibold 
    ...
    <div class="space-y-2 border-t border-gray-100 pt-6">
        <a href="<%=request.getContextPath()%>/student/home" title="Back to Learning"
           class="flex items-center gap-4 px-3 py-3 transition font-bold text-gray-400 hover:text-indigo-600">
            <span class="material-icons-round text-2xl flex-shrink-0">home</span>
            <span class="hidden lg:block text-xs uppercase tracking-widest whitespace-nowrap">Portal Home</span>
        </a>

        <a href="<%=request.getContextPath()%>/logout" title="Sign Out"
           class="flex items-center gap-4 px-3 py-3 transition font-bold text-gray-400 hover:text-red-500">
            ...
            <span class="hidden lg:block text-xs uppercase tracking-widest whitespace-nowrap">Sign Out</span>
        </a>
    </div>
</aside>