...
<main class="flex-grow p-6 lg:p-10 overflow-y-auto">
    ...
    <div class="max-w-7xl mx-auto bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
        <div class="flex items-center gap-6">
            <div class="relative">
                <img src="${not empty sessionScope.profilePic ? pageContext.request.contextPath.concat(sessionScope.profilePic) : pageContext.request.contextPath.concat('/assets/images/default-avatar.png')}"
            ...
            <div>
                ...
                <div class="flex items-center gap-4 mt-4 text-[10px] font-black uppercase tracking-widest text-gray-400">
                    <span class="flex items-center gap-1">
                        <span class="material-icons-round text-sm">verified</span> Verified User
                    </span>
                    <span class="flex items-center gap-1">
        ...
        <a href="<%=request.getContextPath()%>/user/settings"
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<%=request.getContextPath()%>/user/UserHome" class="text-primary font-bold text-xs hover:underline flex items-center gap-1">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <c:if test="${empty enrolledPaths}">
                <div class="col-span-full text-center py-12">
                    ...
                    <a href="<%=request.getContextPath()%>/user/career" class="text-primary font-bold hover:underline inline-block mt-4">
            ...
            <c:forEach var="pathInfo" items="${enrolledPaths}">
                ...
                <div class="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm group hover:shadow-xl transition-all duration-300">
                    ...
                    <a href="<%=request.getContextPath()%>/user/progress"
