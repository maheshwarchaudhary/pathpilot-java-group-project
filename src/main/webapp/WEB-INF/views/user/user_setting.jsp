...
<div class="relative group">
    <img id="profilePreview" 
         src="${not empty sessionScope.profilePic ? pageContext.request.contextPath.concat(sessionScope.profilePic).concat('?t=').concat(java.lang.System.currentTimeMillis()) : pageContext.request.contextPath.concat('/assets/images/default-avatar.png')}"
    ...
    <label for="imageInput" class="absolute -bottom-2 -right-2 bg-primary p-2.5 rounded-xl shadow-xl cursor-pointer hover:bg-primary-dark transition-all border-2 border-white">
        ...
        <div class="max-w-4xl mx-auto">
            <form id="profileForm" action="<%=request.getContextPath()%>/user/update-profile" method="POST" enctype="multipart/form-data" class="space-y-8">
